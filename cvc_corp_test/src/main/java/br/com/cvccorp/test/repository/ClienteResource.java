...
public class ClienteResource {
	...
	@Autowired
	private ConsumoAPIHotels apiHotels;

	/**
	 * Lista Todos os hoteis por código de cidade
	 * 
	 */
	@GetMapping("/hoteis/{idCidade}")
	public List<Hotel> buscarHoteis(@PathVariable long idCidade){
        return apiHotels.buscarHoteis(idCidade);
	}
	...
	public Hotel buscarHotel(@PathVariable long idHotel){
        return apiHotels.buscarHotel(idHotel);
	}
