...
public class IpVigilanteDTO {
	...
	public IpVigilanteDTO(String ipv4, String continent_name,
			String country_name, String subdivision_1_name,
			String subdivision_2_name, String city_name, String latitude,
			String longitude) {
		super();
		this.ipv4 = ipv4;
	...
	public String toString() {
		return "IpVigilanteDTO [ipv4=" + ipv4 + ", continent_name="
				+ continent_name + ", country_name=" + country_name
				+ ", subdivision_1_name=" + subdivision_1_name
				+ ", subdivision_2_name=" + subdivision_2_name + ", city_name="
				+ city_name + ", latitude=" + latitude + ", longitude="
				+ longitude + "]";
	}
